            ...
            <div className="sideMenu" style={!sideMenuFlag ? {display: "none"} : undefined}>
                <div className="sideMenuBox">
                    ...
                    <ul className="sideMenuUl">
                        {/* <li><span onClick={() => openWindow("https://t.me/polybees")}>Community <span class="material-icons" style={{"font-size":"13px"}}>open_in_new</span></span></li> */}
                        <li><span onClick={() => openWindow("https://t.me/polybees")}>Community</span></li>
                        ...
                        <li>
                            <ul className="sideMenuIconLabel" onClick={() => openWindow("https://sale.polybees.network")}>
                                <li><img src={cosmostationLogo} style={{"width":"24px"}} /></li>
                                <li><span>Polybees.Network</span></li>
                            </ul>
                        </li>
                    </ul>
